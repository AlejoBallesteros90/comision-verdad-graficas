...
new_df <- df %>%
  select(
          ...
          "A_5",               # Grupo que desarrollo la exp
          "B_1",               # Sector al que pertenece el tipo de actor
          "B_4",               # Descripcion de la exp
          "C_1",               # Convivencia Democratica
          "C_2",               # C2: Resistencias no violentas
          "C_3",               # C3: Transformaciones para la paz
          "C_4",               # C4: Gestion pacifica de conflictos
          "C_21",              # C2: Defensa de la vida y del territorio
          "C_22",              # C2: Proteger de los atasques selectivos a lideres (as) y activistas
          "C_23",              # C2: Alternativas economicas al/de desarrollo       
          "C_24",              # C2: Defensa de identidades colectivas
          "C_31",              # C3: Cultura y educacion de paz
          "C_32",              # C3: Procesos de memoria colectiva
          "C_33",              # C3: Organizacion y articulacion a redes
          "C_34",              # C3: Procesos de desarrollo y paz
          "C_35",              # C3: Proteccion del medioambiente
          "C_41",              # C4: Dialogo y negociacion especificos
          "C_42",              # C4: Dialogo y negociacion estrategicos
          "C_43"               # C4: Procesos de reincorporacion y de reconciliacion de excombatientes
        ) 
...
#exportar csvs
write_delim(new_df, iniciativas_csv, delim = ",", quote = c("all"))
